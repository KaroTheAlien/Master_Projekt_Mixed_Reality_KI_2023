...
namespace UtilityAI
{
    public class UtilityAIDirections : MonoBehaviour
    {
        ...
        public void CalculateBestAction(Action[] availableActions)
        {
            ...
            if (availableActions.Length > 0)
            {
                ...
                {
                    Debug.Log("Alle Direction Scores sind 0 ");
                    bBestActionFound = false;
                    return;
                }

                bestAction = availableActions[bestActionIndex];
                //Debug.Log("UtilityAIDirections::best aktion ist: " + bestAction.name + "Score: " + bestAction.Score.ToString());
